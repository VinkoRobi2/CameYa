      ...
      <div className="relative z-10 text-center text-white px-4">
        ...
        <Reveal>
          <p className="mt-4 text-lg max-w-2xl mx-auto text-gray-200">
            Conecta estudiantes y jóvenes con empleos de corta duración: rápido, seguro, flexible y joven.
          </p>
        </Reveal>
        <div className="mt-8 flex justify-center gap-4 flex-wrap">
          <Reveal><button className="h-12 px-6 rounded-full bg-primary text-white font-semibold hover:opacity-90 transition-opacity">Buscar CameYo</button></Reveal>
          <Reveal><button className="h-12 px-6 rounded-full bg-white text-black font-semibold hover:bg-gray-200 transition-colors">Publicar CameYo</button></Reveal>
        </div>
      </div>
    </section>
  );
